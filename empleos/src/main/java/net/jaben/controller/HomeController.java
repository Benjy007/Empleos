...
public class HomeController {
	...
	public String mostrarHome(Model model) {
		...
		//model.addAttribute("fecha", hoyEs + new Date());
	...
	private List<Vacante> getVacantes(){
		...
		try {
			// Creamos la orferta de Trabajo 1.
			...
			// Creamos la orferta de Trabajo 2.
			...
			// Creamos la orferta de Trabajo 3.
			...
			vacante4.setImagen("empresa2.png");
			
			/**
			 * Agregamos los 4 objetos a tipo Variante a la lista ...
			 */
